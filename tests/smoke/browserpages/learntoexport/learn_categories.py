...
SubURLs = {
    ...
    "opportunity-right-you": URLs.GREAT_MAGNA_LESSONS_CHOOSING_THE_RIGHT_OPPORTUNITIES.absolute_template,
    ...
    "quantifying-customer-demand-how-much-might-you-sell": URLs.GREAT_MAGNA_LESSONS_QUANTIFY_CUSTOMER_DEMAND_HOW_MUCH_YOU_MIGHT_SELL.absolute_template,
    "understand-market-barriers": URLs.GREAT_MAGNA_LESSONS_UNDERSTAND_MARKET_BARRIERS.absolute_template,
    "how-assess-ease-entry-new-market": URLs.GREAT_MAGNA_LESSONS_HOW_TO_ASSESS_EASE_OF_ENTRY_INTO_A_NEW_MARKET.absolute_template,
    ...
    "sell-direct-your-customer": URLs.GREAT_MAGNA_LESSONS_SELL_DIRECT_TO_YOUR_CUSTOMER.absolute_template,
    "international-e-commerce": URLs.GREAT_MAGNA_LESSONS_SELL_WITH_INTERNATIONAL_E_COMMERCE.absolute_template,
    "set-joint-ventures-abroad": URLs.GREAT_MAGNA_LESSONS_SET_UP_JOINT_VENTURES_ABROAD.absolute_template,
    "setting-franchise-abroad": URLs.GREAT_MAGNA_LESSONS_SETTING_UP_A_FRANCHISE_ABROAD.absolute_template,
    "how-set-business-abroad/": URLs.GREAT_MAGNA_LESSONS_HOW_TO_SET_UP_A_BUSINESS_ABROAD.absolute_template,
    "understand-local-business-culture-your-target-market": URLs.GREAT_MAGNA_LESSONS_UNDERSTAND_THE_LOCAL_BUSINESS_CULTURE_IN_YOUR_TARGET_MARKET.absolute_template,
    ...
    "how-prepare-trade-mission": URLs.GREAT_MAGNA_LESSONS_HOW_TO_PREPARE_FOR_A_TRADE_MISSION.absolute_template,
    "how-prepare-trade-show-attendee": URLs.GREAT_MAGNA_LESSONS_HOW_TO_PREPARE_FOR_A_TRADE_SHOW_AS_AN_ATTENDEE.absolute_template,
    "how-prepare-trade-show-exhibitor": URLs.GREAT_MAGNA_LESSONS_HOW_TO_PREPARE_FOR_A_TRADE_SHOW_AS_AN_EXHIBITOR.absolute_template,
    "how-adapt-your-website-international-audience": URLs.GREAT_MAGNA_LESSONS_HOW_TO_ADAPT_YOUR_WEBSITE_FOR_AN_INTERNATIONAL_AUDIENCE.absolute_template,
    "understand-digital-marketing": URLs.GREAT_MAGNA_LESSONS_UNDERSTAND_DIGITAL_MARKETING.absolute_template,
    ...
    "operating-business-integrity": URLs.GREAT_MAGNA_LESSONS_OPERATING_WITH_BUSINESS_INTEGRITY.absolute_template,
    ...
    "freight-forwarders": URLs.GREAT_MAGNA_LESSONS_FREIGHT_FORWARDERS.absolute_template,
    "understand-regulations-around-supplying-service": URLs.GREAT_MAGNA_LESSONS_UNDERSTAND_REGULATIONS_AROUND_SUPPLYING_A_SERVICE.absolute_template,
    ...
    "how-avoid-cashflow-challenges-when-exporting": URLs.GREAT_MAGNA_LESSONS_HOW_TO_AVOID_CASHFLOW_CHALLENGES_WHEN_EXPORTING.absolute_template,
    ...
    "insure-against-non-payment": URLs.GREAT_MAGNA_LESSONS_HOW_TO_INSURE_AGAINST_NON_PAYMENT.absolute_template,
    "how-create-export-invoice": URLs.GREAT_MAGNA_LESSONS_HOW_TO_CREATE_AN_EXPORT_INVOICE.absolute_template,
    ...
    "managing-exchange-rates": URLs.GREAT_MAGNA_LESSONS_HOW_TO_MANAGE_EXCHANGE_RATES.absolute_template,
