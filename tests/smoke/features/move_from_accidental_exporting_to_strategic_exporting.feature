...
# Scenario:User should be able to view Lesson pages for topic "Move from accidental exporting to strategic exporting" and click Yes and back to check the progress bar on lessons and module and lesson categories section
#
