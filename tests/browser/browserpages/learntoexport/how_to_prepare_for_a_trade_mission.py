...
NAME = "How to prepare for a trade mission"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_HOW_TO_PREPARE_FOR_A_TRADE_MISSION.absolute
PAGE_TITLE = "How to prepare for a trade mission"
