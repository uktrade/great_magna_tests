...
NAME = "How to avoid cashflow challenges when exporting"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_HOW_TO_AVOID_CASHFLOW_CHALLENGES_WHEN_EXPORTING.absolute
PAGE_TITLE = "How to avoid cashflow challenges when exporting"
