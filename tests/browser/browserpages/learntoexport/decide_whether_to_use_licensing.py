...
NAME = "Decide whether to use licensing"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_DECIDE_WHETHER_TO_USE_LICENSING.absolute
PAGE_TITLE = "Decide whether to use licensing"

SELECTORS = {
    "Decide whether to use licensing": {
