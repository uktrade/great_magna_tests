...
NAME = "How to prepare for a trade show as an exhibitor"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_HOW_TO_PREPARE_FOR_A_TRADE_SHOW_AS_AN_EXHIBITOR.absolute
PAGE_TITLE = "How to prepare for a trade show as an exhibitor"
