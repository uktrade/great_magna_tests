...
NAME = "Operating with business integrity"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_OPERATING_WITH_BUSINESS_INTEGRITY.absolute
PAGE_TITLE = "Operating with business integrity"

SELECTORS = {
    "operating with business integrity": {
