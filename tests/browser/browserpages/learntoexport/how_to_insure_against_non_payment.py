...
NAME = "How to insure against non payment"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_HOW_TO_INSURE_AGAINST_NON_PAYMENT.absolute
PAGE_TITLE = "How to insure against non payment"

SELECTORS = {
    "How to insure against non payment": {
